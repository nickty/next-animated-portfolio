...
const About = () => {
  return (
    ...
    >
      <div>
        <div className="p-4 sm:p-8 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:-48 xl:gap-64">
          <div className="flex flex-col gap-12 justify-center">
            <h1 className="font-bold text-2xl">BIOGRAPHY</h1>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Enim
              impedit corrupti reiciendis ipsam facilis, incidunt porro
              assumenda cum magni non velit eius, recusandae provident veniam
              eveniet beatae! Ducimus, dolor omnis!
            </p>
